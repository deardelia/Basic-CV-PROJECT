...
signAcademicHonestyPolicy('Xinyi Yu', 'xyu342');
...
% Your own panorama
new_imgc = im2single(imread('park_c.png'));
new_imgl = im2single(imread('park_l.png'));
new_imgr = im2single(imread('park_r.png'));

stitched_img = stitchImg(new_imgl, new_imgc, new_imgr);

imwrite(stitched_img, 'park_panorama.png');